...
## Tech Stack
- **Language:** Python 3.x
- **AI Model:** Google GenAI (Optimized for Gemini 2.5 Flash), but architecture is LLM agnostic.
...
- **Gemini Optimization:** While LLM agnostic, the prompt engineering and memory structures are currently optimized for Gemini 2.5 Flash.
