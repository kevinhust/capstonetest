...
3. **Pre-Archive Review**:
   - Behave as `ReviewerAgent`: Check for exposed secrets, efficient algorithms, and proper typing. Ensure `tests/` pass.
...
5. **Post-Archive Documentation**:
   - Use the [internal-comms skill](file:.agent/skills/internal-comms/SKILL.md) to draft a brief "Release Note" or "Changelog Entry" for the user.
